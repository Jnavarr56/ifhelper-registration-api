export default function generateUpdateConfirmationEmail(
	codeURL: string
): string {
	return `
    <!DOCTYPE html>
        ...
        <body>
            ...
            <p class="pb-2">
                Someone has requested to update their email on their CommuteAnalyzer account to this one.
            </p>
            <p class="pb-4">
                If it was you confirm this email update by clicking <a href=${codeURL}>here</a>, otherwise ignore.  This link is only good for 1 hour.
            </p>
            <p class="pt-2 pb-6">
