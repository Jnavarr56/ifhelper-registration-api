export default function generateConfirmationEmailHTML(
	name: string,
	codeURL: string
): string {
	return `
    <!DOCTYPE html>
        ...
        <body>
            ...
            <p class="pb-2">
                Welcome to CommuteAnalyzer! You have successfully created an account.
            </p>
            <p class="pb-4">
                Confirm your email by clicking <a href=${codeURL}>here</a> and get started comparing potential commute times!
            </p>
            <p class="pt-2 pb-6">
